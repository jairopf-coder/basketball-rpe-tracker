...
RPETracker.prototype.defaultWeekPlan = function() {
...
RPETracker.prototype.renderWeeklyPlanning = function() {
    ...
    container.innerHTML = `
        <div class="wp-header">
            <div>
                <h2 class="wp-title">Planificación semanal</h2>
                <div class="wp-subtitle">Semana del ${monday.toLocaleDateString('es-ES', {day:'numeric',month:'long'})}</div>
            </div>
            <div class="wp-week-load">
                <div class="wp-week-num">${weekLoad}</div>
